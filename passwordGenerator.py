...
class Ui_GeneratorWindow(object):
    def setupUi(self, GeneratorWindow):
        ...
        self.labelLength.setGeometry(QtCore.QRect(180, 170, 47, 14))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        ...
        self.checkUppercase.setGeometry(QtCore.QRect(130, 330, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        ...
        self.checkSymbols.setGeometry(QtCore.QRect(130, 370, 151, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(14)
        ...
        self.generateButton.setGeometry(QtCore.QRect(150, 290, 75, 23))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        ...
        self.displayGenerator.setGeometry(QtCore.QRect(40, 220, 321, 64))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        self.displayGenerator.setFont(font)
        self.displayGenerator.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.displayGenerator.setAutoFillBackground(False)
        self.displayGenerator.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.displayGenerator.setFrameShadow(QtWidgets.QFrame.Sunken)
